...
class DeveloperToolsPrompts:
    """Prompts for researching and analyzing developer tools."""

    # Extract tool names from broad article content.
    TOOL_EXTRACTION_SYSTEM = textwrap.dedent("""\
    ...
    # Analyze a single tool/company from scraped content.
    TOOL_ANALYSIS_SYSTEM = textwrap.dedent("""\
    ...
    # Produce the final recommendation summary for the user.
    RECOMMENDATIONS_SYSTEM = textwrap.dedent("""\
